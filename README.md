...
```bash
sam local invoke SampleFunction --event events/event.json
```
...
```bash
sam logs -n HelloWorldFunction --stack-name cloud-project --tail
```
...
# This is a group project done for Cloud Computing Aplications project
